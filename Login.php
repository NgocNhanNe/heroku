   ...
   <?php
        if(isset($_POST['btnLogin']))
        {
            ...
            else
            {
                ...
                $pass = md5($pa);
                $res1 = mysqli_query($conn,"SELECT Username, Password,state FROM Customer WHERE Username='$us' AND Password='$pass'") or 
...
<h1>Login</h1>
    ...
    <div class="row">
        ...
        <div class="form-group"> 
            <div class="col-sm-2">
                <input type="submit" name="btnLogin"  class="btn-primary" id="btnLogin" value="Login"/>
                <input type="reset" name="btnCancel"  class="btn-primary" id="btnCancel" value="Cancel"/>
            </div>  
        </div>
    </div>
    </form>
